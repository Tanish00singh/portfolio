      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="font-extrabold leading-[1.05] tracking-tight text-5xl md:text-7xl">
            <span className="block text-white/90">Software &</span>
            <span className="block text-gradient-purple">AI/ML Engineer</span>
          </h1>
          ...
          <p className="mt-8 text-gray-300/90 max-w-xl leading-relaxed">
            {profile.heroIntro}
          </p>
          <p className="mt-4 text-gray-400 max-w-xl leading-relaxed text-sm">
  ...
  <div className="relative w-full aspect-square max-w-[560px] ml-auto">
    ...
    >
      ...
      <g fontFamily="JetBrains Mono, monospace" fontSize="11" fill="#c4b5fd">
        <text x="150" y="172">const tanish = {'{'}</text>
        <text x="160" y="190">role: <tspan fill="#f472b6">'AI/ML Engineer'</tspan>,</text>
        <text x="160" y="208">stack: [<tspan fill="#22d3ee">'python'</tspan>, <tspan fill="#22d3ee">'java'</tspan>],</text>
        <text x="160" y="226">cgpa: <tspan fill="#34d399">8.51</tspan>,</text>
        <text x="160" y="244">rank: <tspan fill="#fbbf24">'AIR 4'</tspan>,</text>
        <text x="160" y="262">build: () =&gt; <tspan fill="#a855f7">'ship it'</tspan>,</text>
        <text x="150" y="282">{'}'};</text>
      </g>
