              ...
              <div className="p-6">
                ...
                <div className="mt-5 grid grid-cols-3 gap-2">
                  {[
                    ...
                    <div
                      key={b.label}
                      className="rounded-md border border-purple-800/30 bg-[#0a0717] px-3 py-2"
                    >
                      <div className="text-[10px] tracking-widest text-purple-400 font-mono">
                        {b.label}
                      </div>
                ...
                <div className="mt-5 flex items-center justify-between font-mono text-xs">
                  <span className="text-purple-300/80">
                    $ {e.type === 'Education' ? 'edu' : 'work'} --status_
                  </span>
                  <span
