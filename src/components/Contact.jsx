...
import { profile, initialComments } from '../mock.js';
import { Send, Linkedin, Instagram, Github, Mail, Heart, MessageCircle, User } from 'lucide-react';
    ...
    <section id="contact" className="relative py-24 px-6">
      ...
      >
        ...
        <motion.div
          ...
          viewport={viewportOnce}
        >
          <motion.div className="glass-card glow-border p-8" variants={fadeUp} transition={transitionMed}>
            <h3 className="text-2xl font-bold text-white">Get in Touch</h3>
            <p className="text-gray-400 mt-2 text-sm">Need help with AI/ML systems, web apps, backend, or coursework collabs? Reach out.</p>
            ...
            <div className="mt-8 pt-6 border-t border-purple-900/30">
              ...
              <div className="space-y-3">
                ...
                <SocialLink icon={Instagram} color="text-pink-400" title="Instagram" sub={profile.socials.instagram.replace(/^https?:\/\/(www\.)?instagram\.com\//, '@')} href={profile.socials.instagram} />
                <SocialLink icon={Github} color="text-gray-200" title="Github" sub={profile.socials.github.replace(/^https?:\/\/(www\.)?github\.com\//, '@')} href={profile.socials.github} />
